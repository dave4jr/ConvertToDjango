...
class InitVariables():
	def __init__(self):
		...
		self.APP_NAME				= "aura"																		# This is the name of the app name and folder name
		self.THEME_DIR				= "/sys/centerstack/materials/templates/aura/templates"										# Enter the directory containing HTML files from the original theme
