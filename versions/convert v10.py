...
class InitVariables():
	def __init__(self):
		...
		self.THEME_DIR				= "/sys/centerstack/materials/templates/metronic/html"
		...
		self.TEMPLATE_BACKUP_ZIP	= "/sys/centerstack/site/scripts/convertToDjango/backups/%s.zip" % self.APP_NAME					# Backup .zip file of all original template HTML files
